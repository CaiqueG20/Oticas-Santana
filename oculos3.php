        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="images/oculos3.jpeg" alt="..." /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder">DII Collection</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">R$300.00</span>
                            <span>R$250.00</span>
                        </div>
