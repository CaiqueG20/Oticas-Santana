        ...
        <header class="bg-dark py-5">
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img src="images/navbar/Carrosel1.PNG" alt="" class="d-block w-100 img-fluid">
                </div>
                <div class="carousel-item">
                    <img src="images/navbar/Carrosel2.PNG" alt="" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="images/navbar/Carrosel3.PNG" alt="" class="d-block w-100">
                </div>
                </div>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <a class="btn btn-success mt-auto" href="https://wa.me/5571991125260" target="_blank">
                                    <i class="fab fa-whatsapp"></i> Comprar via whatssap
                                </a>
                            </div>
                        </div>
                        </div>
        ...
        <div class="card-body p-4">
            <div class="text-center">
                ...
                R$80.00
                    ...
                    <!-- Botão "Adicionar ao WhatsApp" movido para o mesmo nível do oculos 3 -->
